...
async function initHydrolixSession(cfg: HydrolixConfig): Promise<HydrolixClient> {
	...
	logger.notify("Logged into Hydrolix. Received token:", token);
...
async function sendEvent(client: HydrolixClient, event: any) {
	...
	// TODO: We may need to defined a "transformer" to teach Hydrolix how to interpret our analytics data
